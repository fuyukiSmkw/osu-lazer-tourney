...
using osu.Game.Rulesets.LazerTourney.Tournament.Screens.Ladder.Components;
using osuTK;

namespace osu.Game.Rulesets.LazerTourney.Tournament.Screens.TeamIntro
{
                ...
                public BeatmapScoreRow(SeedingBeatmap beatmap)
                {
                    ...
                    InternalChildren = new Drawable[]
                    {
                        new FillFlowContainer
                        {
                            ...
                            Children = new Drawable[]
                            {
                                new TournamentSpriteText { Text = beatmap.Beatmap.Metadata.Title, Colour = TournamentColours.TEXT_COLOUR, },
                                new TournamentSpriteText { Text = "by", Colour = TournamentColours.TEXT_COLOUR, Font = OsuFont.Torus.With(weight: FontWeight.Regular) },
                                new TournamentSpriteText { Text = beatmap.Beatmap.Metadata.Artist, Colour = TournamentColours.TEXT_COLOUR, Font = OsuFont.Torus.With(weight: FontWeight.Regular) },
                            }
                        },
                        new FillFlowContainer
                        {
                            ...
                            Children = new Drawable[]
                            {
                                new TournamentSpriteText { Text = beatmap.Score.ToString("#,0"), Colour = TournamentColours.TEXT_COLOUR, Width = 80 },
                                new TournamentSpriteText
                                    { Text = "#" + beatmap.Seed.Value.ToString("#,0"), Colour = TournamentColours.TEXT_COLOUR, Font = OsuFont.Torus.With(weight: FontWeight.Regular) },
                            }
                        },
                    };
                }
            ...
            internal partial class RowDisplay : CompositeDrawable
            {
                public RowDisplay(string left, string right)
                {
                    ...
                    InternalChildren = new Drawable[]
                    {
                        ...
                        {
                            Text = left,
                            Colour = TournamentColours.TEXT_COLOUR,
